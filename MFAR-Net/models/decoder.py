...
def build_decoder(args):
    ...
    model = Decoder(num_classes=args.num_classes,
...
if __name__ == "__main__":
    decoder = Decoder(feat_channels=[256, 256, 256],
                      feat_strides=[8, 16, 32],
                      hidden_dim=256,
                      num_levels=3,
                      num_queries=300,
                      ...
                      num_denoising=100,
                      eval_idx=-1,
                      eval_spatial_size=[640, 640]).eval()
    # print(decoder)

    features = [torch.randn(2, 256, 80, 80), torch.randn(2, 256, 40, 40), torch.randn(2, 256, 20, 20)]
